...
const setWavelengthLayerStyle = (labelsOn = true) => {
  return (() => {
    ...
    return (feature) => {
      ...
      if (labelsOn) {
        labelStyle.getText().setText(`${feature.get('name')} (CH ${feature.get('channel')})`);
      } else {
...
class WavelengthLayer {
  constructor(visibility) {
    this.visibility = visibility;
    this.name = 'pl_spans_layer';
    this.style = setWavelengthLayerStyle;
